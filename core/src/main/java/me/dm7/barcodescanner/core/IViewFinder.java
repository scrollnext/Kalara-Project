...
public interface IViewFinder {
    ...
    /**
     * Provides {@link android.graphics.Rect} that identifies area where barcode scanner can detect visual codes
     ...
     *
     * @return {@link android.graphics.Rect} that identifies barcode scanner area
     */
    Rect getFramingRect();
